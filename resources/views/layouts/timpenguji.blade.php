...
<head>
    ...
    <style>
        /* Sama seperti layout Calon Aslab, ganti menu sesuai Tim Penguji */
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-menu">
            <div class="nav-section">
                ...
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-users"></i><span>Daftar Calon Aslab</span><span class="nav-badge">8</span></a></div>
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-clipboard-list"></i><span>Penilaian</span></a></div>
            </div>
            <div class="nav-section">
                ...
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-chart-bar"></i><span>Rekap Nilai</span></a></div>
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-question-circle"></i><span>Panduan Penilaian</span></a></div>
            </div>
            <div class="nav-section">
        ...
        <div class="top-bar">
            <div class="top-bar-left">
                ...
                <div class="page-title">
                    <h1>@yield('page-title', 'Dashboard Penguji')</h1>
                    <p>@yield('page-description', 'Selamat datang, Tim Penguji Seleksi Asisten Laboratorium')</p>
                </div>
            </div>
            <div class="top-bar-right">
                <div class="search-input"><i class="fas fa-search"></i><input type="text" placeholder="Cari calon aslab..."></div>
                ...
                <div class="user-menu">
                    ...
                    <div class="user-info"><div class="name">Tim Penguji</div><div class="role">Penguji</div></div>
    ...
    <script>
        ...
        const isCollapsed = localStorage.getItem('sidebarCollapsedPenguji') === 'true';
        if (isCollapsed) {
        ...
        sidebarToggle.addEventListener('click', function() {
            ...
            localStorage.setItem('sidebarCollapsedPenguji', collapsed);
            if (collapsed) {
                collapseIcon.classList.remove('fa-chevron-left');
                collapseIcon.classList.add('fa-chevron-right');
            } else {
